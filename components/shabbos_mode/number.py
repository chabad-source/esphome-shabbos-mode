...
NUMBER_TYPES = {
    ...
    "start_offset_minutes": ("SETTING_NUMBER_START_OFFSET_MINUTES", -300.0, 300.0, 1.0),
    "end_degree": ("SETTING_NUMBER_END_DEGREE", 0.0, 30.0, 0.1),
    "end_offset_minutes": ("SETTING_NUMBER_END_OFFSET_MINUTES", -300.0, 300.0, 1.0),
    ...
    "early_take_in_offset_minutes": ("SETTING_NUMBER_EARLY_TAKE_IN_OFFSET_MINUTES", -300.0, 300.0, 1.0),
